...
import { publicationSearchWithFilterPmids } from '../../../../../../../../controllers/db/reports/publication.report.search.controller';
...
export default async function handler(req: NextApiRequest,
    ...
    if (req.method === "POST") {
        if(req.headers.authorization !== undefined && req.headers.authorization === reciterConfig.backendApiKey) {
            ...
            try{
                const searchOutput: any = await publicationSearchWithFilterPmids(req, res)
