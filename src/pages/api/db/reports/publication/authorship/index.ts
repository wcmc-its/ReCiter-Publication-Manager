...
import { generateAuthorshipReportCSV } from '../../../../../../../controllers/db/reports/publication.report.controller';
...
export default async function handler(req: NextApiRequest,
    ...
    if (req.method === "POST") {
        if(req.headers.authorization !== undefined && req.headers.authorization === reciterConfig.backendApiKey) {
            ...
            try{
                const searchOutput: any = await generateAuthorshipReportCSV(req, res)
