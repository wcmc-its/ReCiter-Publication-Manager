...
const Publication: FunctionComponent<FuncProps> = (props) => {
    ...
    var evidancePopoverHtml = "<strong>" + reciterArticle.totalScoreNonStandardized + " :</strong> Raw score<br/><strong>" + reciterArticle.totalScoreStandardized + " : </strong>Standardized score (1-10)<br/><br/>These scores represent the strength of evidence supporting the possibility that <b>"+ props.fullName +"</b> wrote this article. To investigate which evidence is used to generate this score, click on \"Show evidence behind this suggestion.\"";
