export const reciterConfig = {
    ...
    reciter: {
        ...
        featureGenerator: {
            featureGeneratorEndpoint:
                process.env.NEXT_PUBLIC_RECITER_FEATURE_GENERATOR_ENDPOINT,
        ...
        featureGeneratorByGroup: {
            featureGeneratorByGroupEndpoint:
                process.env
                    .NEXT_PUBLIC_RECITER_FEATURE_GENERATOR_GROUP_ENDPOINT,
        ...
        reciterPubManagerAuthenticationEndpoint:
            process.env.NEXT_PUBLIC_RECITER_AUTHENTICATION_ENDPOINT,
        /**
         * This endpoint is to update the feedback for users.
         */
        reciterUpdateGoldStandardEndpoint:
            process.env.NEXT_PUBLIC_RECITER_GOLD_STANDARD_ENDPOINT,
        /**
        ...
        reciterUserFeedbackEndpoints: {
            saveUserFeedback:
                process.env.NEXT_PUBLIC_RECITER_SAVE_USER_FEEDBACK,
            deleteUserFeedback:
                process.env.NEXT_PUBLIC_RECITER_DELETE_USER_FEEDBACK,
            findUserFeedback:
                process.env.NEXT_PUBLIC_RECITER_FIND_USER_FEEDBACK,
        },
    },
    /**
    ...
    reciterPubmed: {
        ...
        searchPubmedCountEndpoint:
            process.env.NEXT_PUBLIC_RECITER_SEARCH_COUNT_PUBMED,
    },
    /**
