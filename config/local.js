export const reciterConfig = {
    ...
    reciter: {
        ...
        reciterIdentityEndpoints: {
             ...
             */
            identityByUid: 'http://RECITER-SERVICE.reciter.svc.cluster.local/reciter/find/identity/by/uid',
            /**
             ...
             */
            getAllIdentity: 'http://RECITER-SERVICE.reciter.svc.cluster.local/reciter/find/all/identity',
            /**
         ...
         */
        featureGenerator: {
            featureGeneratorEndpoint: 'http://RECITER-SERVICE.reciter.svc.cluster.local/reciter/feature-generator/by/uid',
         ...
         */
         featureGeneratorByGroup: {
            featureGeneratorByGroupEndpoint: 'http://RECITER-SERVICE.reciter.svc.cluster.local/reciter/feature-generator/by/group',
            ...
            maxResultsOnGroupView: 10,
            incrementResultsBy: 10,
        },
        /**
         * This is the endpoint in ReCiter-Publication-Manager controller for authentication.
         */
        reciterPubManagerAuthenticationEndpoint: 'http://RECITER-SERVICE.reciter.svc.cluster.local/reciter/publication/manager/authenticate',
        /**
         * This endpoint is to update the feedback for users.
         */
        reciterUpdateGoldStandardEndpoint: 'http://RECITER-SERVICE.reciter.svc.cluster.local/reciter/goldstandard',
        /**
        ...
        reciterUserFeedbackEndpoints: {
            saveUserFeedback: 'http://RECITER-SERVICE.reciter.svc.cluster.local/reciter/publication/manager/userfeedback/save',
            deleteUserFeedback: 'http://RECITER-SERVICE.reciter.svc.cluster.local/reciter/publication/manager/userfeedback/delete',
            findUserFeedback: 'http://RECITER-SERVICE.reciter.svc.cluster.local/reciter/publication/manager/userfeedback/find'
        }
    },
    /**
     ...
     */
    reciterPubmed: {
        searchPubmedEndpoint: 'http://RECITER-PUBMED-SERVICE.reciter.svc.cluster.local/pubmed/query-complex/',
        searchPubmedCountEndpoint: 'http://RECITER-PUBMED-SERVICE.reciter.svc.cluster.local/pubmed/query-number-pubmed-articles/'
    },
    /**
